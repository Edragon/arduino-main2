...
void loop()
{
  ...
  unsigned long adcMilliVolts = (static_cast<unsigned long>(adcValue) * 5000UL) / 1023UL;
  uint8_t data[RH_NRF24_MAX_MESSAGE_LEN];
  
  snprintf((char*)data, sizeof(data), "Hello World! A1=%u %lumV", adcValue, adcMilliVolts);
