...
char printDensity = 5; //Not sure what the defaut is. Testing shows the max helps darken text. From page 23.
char printBreakTime = 5; //Not sure what the defaut is. Testing shows the max helps darken text. From page 23.
